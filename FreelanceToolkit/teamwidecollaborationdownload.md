...
**IMPORTANT:** In current state, when a project ends, freelancers can easily be removed from Teams and will cease to receive project and document updates. However, once removed, freelancers can read your documents, just not the most up to date versions"
