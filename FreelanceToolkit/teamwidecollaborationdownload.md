...
**IMPORTANT:** In the current state, when a project ends, you can easily remove freelancers from Teams and they will cease to receive project and document updates. However, removed freelancers can still read Team documents, just not the most up to date versions.
